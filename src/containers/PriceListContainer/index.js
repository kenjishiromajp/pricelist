...
import { HOMESTAY_PROPS, MELBOURNE, SYDNEY, SHARE_HOUSE_STANDARD_PROPS, SHARE_HOUSE_PREMIUM_PROPS, HOMESTAY_PRICES, SHAREHOUSE_PREMIUM_PRICES, SHAREHOUSE_STANDARD_PRICES, UNDERAGE_TAX } from './constants';
...
class PriceListContainer extends Component {
  ...
  getAccommodationOptions = () => {
    const { priceListForm } = this.state;
    if(this.isUnderAge()){
      return [{ ...HOMESTAY_PROPS, price: HOMESTAY_PRICES[priceListForm.city] + UNDERAGE_TAX, ...priceListForm, checkIn: '1', checkOut: '1' }];
    }
